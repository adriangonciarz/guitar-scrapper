...
#
#     def find_matching_brand(self, search_string) -> str:
#         for brand in self.brands:
...
#         return ''
#
#     def find_matching_model(self, brand_name, search_string):
...
class Item:
    ...
    def model(self):
        if self.brand:
            return self.brand_manager.find_matching_model(self.name)
